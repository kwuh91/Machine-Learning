...
\addcontentsline{toc}{subsubsection}{\protect\numberline{}Обоснование применения МНК}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{}Построение исходных графиков}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{}Полиномиальная регрессия}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{}Описание применяемых методов библиотеки}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{}Описание хода решения}
...
Для начала заведем две вспомогательные функции:
...
\subsubsection*{{Линейная регрессия с помощью scipy.stats.linregress}}\vspace{-20pt}\rule{\linewidth}{0.1mm}
\addcontentsline{toc}{subsubsection}{\protect\numberline{}Линейная регрессия с помощью scipy.stats.linregress}
\vspace{-30pt}\paragraph*{{Описание применяемых методов библиотеки}}\vspace{-20pt}\rule{\linewidth}{0.1mm}
\addcontentsline{toc}{paragraph}{\protect\numberline{}Описание применяемых методов библиотеки}

Воспользуемся методом \textbf{linregress} модуля \textbf{stats} библиотеки \textbf{scipy} для 
нахождения линейной регрессии:

\definecolor{mygray}{rgb}{0.85, 0.85, 0.85}
\begin{tcolorbox}[colback=mygray, boxrule=0pt, arc=0pt]
    \textbf{linregress(}x, y=None, alternative='two-sided'\textbf{)} \\
    Находит линейную регрессию методом наименьших квадратов для 
    двух наборов измерений.
\end{tcolorbox}
...
Результаты получились очень похожими на те, что были найдены аналитически и при помощи \high{numpy}.

\subsubsection*{{Линейная регрессия с помощью scipy.stats.least\_squares}}\vspace{-20pt}\rule{\linewidth}{0.1mm}
\addcontentsline{toc}{subsubsection}{\protect\numberline{}Линейная регрессия с помощью scipy.stats.least\_squares}
\vspace{-30pt}\paragraph*{{Описание применяемых методов библиотеки}}\vspace{-20pt}\rule{\linewidth}{0.1mm}
\addcontentsline{toc}{paragraph}{\protect\numberline{}Описание применяемых методов библиотеки}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{}Линейная регрессия с помощью scipy.stats.lstsq}
\vspace{-30pt}\paragraph*{{Описание применяемых методов библиотеки}}\vspace{-20pt}\rule{\linewidth}{0.1mm}
\addcontentsline{toc}{paragraph}{\protect\numberline{}Описание применяемых методов библиотеки}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{}Полиномиальная регрессия с помощью scipy.optimize.least\_squares}
\vspace{-30pt}\paragraph*{{Описание применяемых методов библиотеки}}\vspace{-20pt}\rule{\linewidth}{0.1mm}
\addcontentsline{toc}{paragraph}{\protect\numberline{}Описание применяемых методов библиотеки}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{}Полиномиальная регрессия с помощью scipy.optimize.lstsq}
\vspace{-30pt}\paragraph*{{Описание применяемых методов библиотеки}}\vspace{-20pt}\rule{\linewidth}{0.1mm}
\addcontentsline{toc}{paragraph}{\protect\numberline{}Описание применяемых методов библиотеки}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{}Построение совмещенных графиков}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{}Сравнение коэффициентов}
